...
export default(): JSX.Element => {
        ...
        return (
            <Form className={styles.newsletter__form}>
                <InputGroup className="mb-2 mr-sm-2 mb-sm-0">
                    ...
                    />
                    <Button className={styles.newsletter__button} role="primary" onClick={submit}>Subscribe</Button>
                </InputGroup>
            </Form>
        );
    }
    ...
    return (
        <div className={styles.newsletter}>
            ...
            <MailchimpSubscribe url={url} render={({ subscribe }: any) => (
                <SubscribeForm onValidated={(formData: any) => subscribe(formData)} />
            )} />
        </div>
    )
};