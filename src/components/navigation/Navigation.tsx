                ...
                >
                    ...
                    <Offcanvas.Body>
                        <Nav className="justify-content-start flex-grow-1">
                            ...
                            <Link href="/serviced-offices/" className={`nav-link ${styles.navigation__link}`}>
                                Serviced offices
                            </Link>
                            <Link href="/meeting-rooms/" className={`nav-link ${styles.navigation__link}`}>
                                Meeting rooms
                            </Link>
                            <Link href="/contact-us/" className={`nav-link ${styles.navigation__link}`}>
                                Contact
                            </Link>
                            <Link href="/about-us/" className={`nav-link ${styles.navigation__link}`}>
                                About
                            </Link>
                        </Nav>
